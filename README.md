...
Almost every looping mechanism implemented here is either self recursive or it uses another function from the same library. Spread is used for pattern matching or array destructuring. Object.entries is used to split objects. Also, we get the function's arity with function.prototype.length. These are some exceptions, we'll try to rid ourseves of them too.
